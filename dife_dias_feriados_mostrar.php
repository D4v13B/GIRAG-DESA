...
<tbody>
<?php
$f_dife_descripcion=$_GET['f_dife_descripcion'];
$f_dife_fecha=$_GET['f_dife_fecha'];
$where='';
if($f_dife_descripcion!='' && $f_dife_descripcion!='null') $where .="AND a.dife_descripcion LIKE '%$f_dife_descripcion%'";
if($f_dife_fecha!='' && $f_dife_fecha!='null') $where .="AND a.dife_fecha LIKE '%$f_dife_fecha%'";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'dife_descripcion'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'dife_fecha'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'dife_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'dife_id'); ?>)' ;>
