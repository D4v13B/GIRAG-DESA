...
<th class=tabla_datos_titulo>Codigo de aereouerto</th>
<th class=tabla_datos_titulo>Nombre de aereopuerto</th>
...
$f_aeco_codigo=$_GET['f_aeco_codigo'];
$f_aeco_nombre=$_GET['f_aeco_nombre'];
$where='';
if($f_pais_id!='' && $f_pais_id!='null') $where .="AND a.pais_id IN ($f_pais_id)";
if($f_aeco_codigo!='' && $f_aeco_codigo!='null') $where .="AND a.aeco_codigo LIKE '%$f_aeco_codigo%'";
if($f_aeco_nombre!='' && $f_aeco_nombre!='null') $where .="AND a.aeco_nombre LIKE '%$f_aeco_nombre%'";

$qsql ="select * from aereopuertos_codigos a,paises b
WHERE 1=1 
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'aeco_codigo'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'aeco_nombre'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'aeco_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'aeco_id'); ?>)' ;>
