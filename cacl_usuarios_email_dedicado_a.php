<script>
function crear() {
$('#result').load('cacl_usuarios_email_dedicado_a_crear.php'
,
{
...
function modificar() {
$('#result').load('cacl_usuarios_email_dedicado_a_modificar.php?id=' + $('#h2_id').val()
,
{
...
if(agree) {
   $('#result').load('cacl_usuarios_email_dedicado_a_borrar.php?id=' + id
   ,
   function()
     {
     mostrar();
...
$('#modal2').center();
$('#h2_id').val(id);
$.get('cacl_usuarios_email_dedicado_a_datos.php?id=' + id, function(data){
     var resp=data;
     r_array = resp.split('||');
     //alert(r_array[0]);
...
function mostrar() {
$('#datos_mostrar').load('cacl_usuarios_email_dedicado_a_mostrar.php?nochk=jjjlae222'
