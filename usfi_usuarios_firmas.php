              ...
              <div class="modal-body">
                <form class="card-body" id="usuario_firma" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control custom-select" name="usuario_firma" id="usua_id">
                  ...
                  <div class="form-group">
                    ...
                    <input accept="image/jpeg, image/png" class="form-control" type="file" id="usfi_ref" name="usfi_ref" />
                  </div>
