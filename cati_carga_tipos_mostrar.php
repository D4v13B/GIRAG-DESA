...
<tr>
<th class=tabla_datos_titulo>Tipo de Carga</th>
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'cati_nombre'); ?></td>
            ...
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'cati_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'cati_id'); ?>)' ;>
