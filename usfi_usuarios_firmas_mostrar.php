...
$where='';
if($f_usua_id!='' && $f_usua_id!='null') $where .="AND a.usua_id IN ($f_usua_id)";

$qsql ="select * from usuarios_firmas a,usuarios b
WHERE 1=1 
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usua_nombre'); ?></td>
            ...
            <div Class='btn-group btn-group-sm'>
                     <!-- <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'usfi_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'usfi_id'); ?>)' ;>
