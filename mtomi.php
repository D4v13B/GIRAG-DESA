 ...
 * queries (@see https://php.net/manual/en/pdo.prepared-statements.php) to
...
namespace {
    ...
    if (!extension_loaded('mysql')) {
        ...
        function mysql_tablename($result, $row)
        {
            ...
            // Alias as per https://lxr.php.net/xref/PHP_5_6/ext/mysql/php_mysql.c#321
...
namespace Dshafik {
    ...
    class MySQL
    {
        ...
        {
            // Order of flags taken from https://lxr.php.net/xref/PHP_5_6/ext/mysql/php_mysql.c#2507
            $flags = array(
