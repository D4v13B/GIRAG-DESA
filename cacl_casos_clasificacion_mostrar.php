...
<tr>
<th class=tabla_datos_titulo>Casos clasificación</th>
<th class=tabla_datos_titulo_icono></th>
</tr>
</thead>
<tbody>
<?php
$f_cacl_nombre=$_GET['f_cacl_nombre'];
$where='';
if($f_cacl_nombre!='' && $f_cacl_nombre!='null') $where .="AND a.cacl_nombre LIKE '%$f_cacl_nombre%'";

$qsql ="select * from casos_clasificacion";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'cacl_nombre'); ?></td>
            ...
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'cacl_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'cacl_id'); ?>)' ;>
