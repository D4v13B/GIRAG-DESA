<script>
function crear() {
$('#result').load('cati_carga_tipos_crear.php'
,
{
    'i_cati_nombre':  $('#i_cati_nombre').val()
    }
    ,
    function(){
        $('#modal').hide('slow');
...
function modificar() {
$('#result').load('cati_carga_tipos_modificar.php?id=' + $('#h2_id').val()
,
{
     'm_cati_id':  $('#m_cati_id').val(),
     'm_cati_nombre':  $('#m_cati_nombre').val()
    }
    ,
    function(){
       $('#modal2').hide('slow');
...
if(agree) {
   $('#result').load('cati_carga_tipos_borrar.php?id=' + id
   ,
   function()
     {
     mostrar();
...
$('#modal2').center();
$('#h2_id').val(id);
$.get('cati_carga_tipos_datos.php?id=' + id, function(data){
     var resp=data;
     r_array = resp.split('||');
     //alert(r_array[0]);
     $('#m_cati_nombre').val(r_array[1]);
     });
}
function mostrar() {
$('#datos_mostrar').load('cati_carga_tipos_mostrar.php');
}
</script>
<div id='separador'>
...
<table>
<tr>
<td class='etiquetas'>Tipo de Carga:</td>
<td><input type='text' id=i_cati_nombre size=40 class='entradas'></td>
</tr>
<tr>
...
<tr>
<td class='etiquetas'>Tipo de Carga:</td>
<td><input type='text' id=m_cati_nombre size=40 class='entradas'></td>
</tr>
<tr>
