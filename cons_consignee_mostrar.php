...
<tbody>
<?php
$f_cons_nombre=$_GET['f_cons_nombre'];
$f_pais_id=$_GET['f_pais_id'];
$f_cons_ciudad=$_GET['f_cons_ciudad'];
$f_cons_direccion=$_GET['f_cons_direccion'];
$where='';
if($f_cons_nombre!='' && $f_cons_nombre!='null') $where .="AND a.cons_nombre LIKE '%$f_cons_nombre%'";
if($f_pais_id!='' && $f_pais_id!='null') $where .="AND a.pais_id IN ($f_pais_id)";
if($f_cons_ciudad!='' && $f_cons_ciudad!='null') $where .="AND a.cons_ciudad LIKE '%$f_cons_ciudad%'";
if($f_cons_direccion!='' && $f_cons_direccion!='null') $where .="AND a.cons_direccion LIKE '%$f_cons_direccion%'";

$qsql ="select * from consignee a,paises b
WHERE 1=1 
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'cons_ciudad'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'cons_direccion'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'cons_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'cons_id'); ?>)' ;>
