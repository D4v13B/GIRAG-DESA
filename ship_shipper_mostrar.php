...
<th class=tabla_datos_titulo>Ciudad</th>
<th class=tabla_datos_titulo>Pais</th>
<th class=tabla_datos_titulo>Dirección</th>
<th class=tabla_datos_titulo_icono></th>
</tr>
</thead>
<tbody>
<?php
$f_ship_nombre=$_GET['f_ship_nombre'];
$f_ship_ciudad=$_GET['f_ship_ciudad'];
$f_pais_id=$_GET['f_pais_id'];
$f_ship_direccion=$_GET['f_ship_direccion'];
$where='';
if($f_ship_nombre!='' && $f_ship_nombre!='null') $where .="AND a.ship_nombre LIKE '%$f_ship_nombre%'";
if($f_ship_ciudad!='' && $f_ship_ciudad!='null') $where .="AND a.ship_ciudad LIKE '%$f_ship_ciudad%'";
if($f_pais_id!='' && $f_pais_id!='null') $where .="AND a.pais_id IN ($f_pais_id)";
if($f_ship_direccion!='' && $f_ship_direccion!='null') $where .="AND a.ship_direccion LIKE '%$f_ship_direccion%'";

$qsql ="select * from shipper a,paises b
WHERE 1=1 
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'ship_nombre'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'ship_ciudad'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'pais_nombre'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'ship_direccion'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'ship_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'ship_id'); ?>)' ;>
