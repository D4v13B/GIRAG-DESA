...
<tr>
<th class=tabla_datos_titulo>Email del usuario</th>
<th class=tabla_datos_titulo>Contraseña</th>
<th class=tabla_datos_titulo>Servidor de SMTP</th>
<th class=tabla_datos_titulo_icono></th>
</tr>
</thead>
<tbody>
<?php
$f_usec_email=$_GET['f_usec_email'];
$f_usec_password=$_GET['f_usec_password'];
$f_usmd_id=$_GET['f_usmd_id'];
$f_usec_estado=$_GET['f_usec_estado'];
$f_usec_smtp=$_GET['f_usec_smtp'];
$where='';
if($f_usec_email!='' && $f_usec_email!='null') $where .="AND a.usec_email LIKE '%$f_usec_email%'";
if($f_usec_password!='' && $f_usec_password!='null') $where .="AND a.usec_password LIKE '%$f_usec_password%'";
if($f_usec_smtp!='' && $f_usec_smtp!='null') $where .="AND a.usec_smtp LIKE '%$f_usec_smtp%'";

$qsql ="select * from usuarios_email_config a
WHERE 1=1 
$where
";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usec_email'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usec_password'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usec_smtp'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'usec_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'usec_id'); ?>)' ;>
