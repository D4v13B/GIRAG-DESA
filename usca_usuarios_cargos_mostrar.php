...
<th class=tabla_datos_titulo>GERENTE</th>
<th class=tabla_datos_titulo_icono></th>
</tr>
</thead>
<tbody>
<?php
$f_usca_nombre=$_GET['f_usca_nombre'];
$f_ucsa_gerente=$_GET['f_ucsa_gerente'];
$where='';
if($f_usca_nombre!='' && $f_usca_nombre!='null') $where .="AND a.usca_nombre LIKE '%$f_usca_nombre%'";
if($f_ucsa_gerente!='' && $f_ucsa_gerente!='null') $where .="AND a.ucsa_gerente IN ($f_ucsa_gerente)";

$qsql ="select usca_id, usca_nombre, if(ucsa_gerente=1,'SI','NO') gerente from usuarios_cargos a
WHERE 1=1 
$where
";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usca_nombre'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'gerente'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'usca_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'usca_id'); ?>)' ;>
