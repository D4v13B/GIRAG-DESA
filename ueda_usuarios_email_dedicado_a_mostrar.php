...
<tr>
<th class=tabla_datos_titulo>Propósito</th>
<th class=tabla_datos_titulo_icono></th>
</tr>
</thead>
<tbody>
<?php
$f_usmd_nombre=$_GET['f_usmd_nombre'];
$where='';
if($f_usmd_nombre!='' && $f_usmd_nombre!='null') $where .="AND a.usmd_nombre LIKE '%$f_usmd_nombre%'";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usmd_nombre'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'usmd_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'usmd_id'); ?>)' ;>
