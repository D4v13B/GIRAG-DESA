...
<tr>
<th class=tabla_datos_titulo>Codigo</th>
...
<tbody>
<?php
$f_coin_codigo=$_GET['f_coin_codigo'];
$f_coin_descripcion=$_GET['f_coin_descripcion'];
$where='';
if($f_coin_codigo!='' && $f_coin_codigo!='null') $where .="AND a.coin_codigo LIKE '%$f_coin_codigo%'";
if($f_coin_descripcion!='' && $f_coin_descripcion!='null') $where .="AND a.coin_descripcion LIKE '%$f_coin_descripcion%'";
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'coin_codigo'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'coin_descripcion'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'coin_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'coin_id'); ?>)' ;>
